...
const units = [
  {
    ...
    icon: TrendingUp,
    img: inverfact,
    pitch: "Educación financiera real, sin humo. Aprende a generar, multiplicar y proteger tu dinero con un sistema probado.",
    bullets: [
      "Mentoría 1:1 con inversionistas activos",
      "Sistema paso a paso: generar, multiplicar, proteger",
      "Comunidad privada y herramientas de tracking",
    ],
    benefit: "Si no sabes manejar tu dinero, nunca vas a crecer. Aquí aprendes a hacerlo de verdad.",
  ...
  },
  {
    ...
    icon: ShoppingBag,
    img: anma,
    pitch: "El nuevo modelo de e-commerce: contenido orgánico + comunidad + lanzamientos tipo infomercial. Adiós al dropshipping tradicional.",
    bullets: [
      "Sistema de lanzamientos en 5 fases",
      "Tres caminos: comprador, dropshipper o proveedor",
      "Tracción real con contenido y comunidad",
    ],
    benefit: "No vendemos productos sueltos. Lanzamos eventos que venden.",
  ...
  },
  {
    ...
    icon: Laptop,
    img: nomadhive,
    pitch: "Sistema estructurado de talento remoto del ecosistema A&O. Proceso de selección, formación y crecimiento por niveles.",
    bullets: [
      "Proceso de selección en 6 etapas",
      "Formación en ventas, cierre y WhatsApp Business",
      "Crecimiento por niveles: Junior → Staff Matriz",
    ],
    benefit: "Esto no es un empleo ni dinero fácil. Es un sistema profesional para escalar por desempeño.",
